...
public class LanguageParser extends Parser {
	...
	public static final int
		...
		T__45=46, TIPO=47, ENTERO=48, DECIMAL=49, CADENA=50, ESCAPE=51, BOOLEANO=52, 
		CARACTER=53, IDENTIFICADOR=54, WS=55, COMENTARIOL=56, COMENTARIOLN=57;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ENTERO", "DECIMAL", "CADENA", "ESCAPE", "BOOLEANO", "CARACTER", "IDENTIFICADOR", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 33495530803672194L) != 0)) {
				{
				{
				setState(30);
				declaraciones();
	...
	public final Lista_valoresContext lista_valores() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 33495530801733632L) != 0)) {
				{
				setState(127);
				expresion(0);
				setState(132);
